...
@section('content')
    ...
    <div class="">
        ...
        @endif
        <form class="form form-horizontal mar-top custom-form" action="{{ route('products.update', $product->id) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control" name="weight" hidden
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" lang="en" class="form-control" name="min_qty" hidden
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <input type="number" class="form-control" name="est_shipping_days" min="1"
                            step="1" placeholder="{{ translate('Shipping Days') }}" hidden>
