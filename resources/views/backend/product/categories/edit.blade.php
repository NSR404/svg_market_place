            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        {{-- <div class="form-group row">
                            <label class="col-md-3 col-form-label">
                                {{ translate('Price Visibility') }}
                            </label>
                            <div class="col-md-9">
                                <div class="form-group d-inline-block mt-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input name="is_product_price_visible" type="checkbox" @if($category->is_product_price_visible) checked @endif>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Cover Image') }}
                                <small>({{ translate('250x250') }})</small></label>
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">
