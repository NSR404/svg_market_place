        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['view_contacts', 'edit_contacts'])
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('contacts.index', ['type' => 'unread']) }}"
                ...
                @canany(['general_settings', 'features_activation', 'language_setup', 'currency_setup',
                    ...
                    'manage_shipping_states', 'manage_shipping_cities', 'manage_zones', 'manage_carriers', 'create_branch',
                    'update_branch', 'view_branch', 'delete_branch'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @canany(['view_branch', 'create_branch', 'update_branch', 'delete_branch'])
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('branches.index', ['lang' => App::getLocale()]) }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['branches.index', 'branches.edit', 'branches.update']) }}">
