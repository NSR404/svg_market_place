...
<div class="modal fade" id="new-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form class="form-default custom-form" role="form" action="{{ route('addresses.store') }}"
                method="POST">
                @csrf
                <div class="modal-body c-scrollbar-light">
                                ...
                                <select class="form-control aiz-selectpicker rounded-0" data-live-search="true"
                                    ...
                                    @foreach ($countries as $key => $country)
                                        <option value="{{ $country->id }}"
                                            @if ($country->code == 'AE') selected @endif>
                    ...
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="tel" id="phone-code" class="form-control mb-3 rounded-0" name="phone"
                                    required>
                            </div>
