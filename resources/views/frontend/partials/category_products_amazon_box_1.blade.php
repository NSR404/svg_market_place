@php
    $products = get_cached_products($category->id);
    $first_box_products = $products->slice(0, 4);
    $second_box_products = $products->slice(5, 2);
    $third_box_products = $products->slice(7)->take(4);
@endphp
<div class="row">
        ...
        <div class="row">
            @foreach ($first_box_products as $product)
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 text-center mb-2 item_box">
                    ...
                    <div class="absolute-top-right aiz-p-hov-icon" style="margin-left:17% !important;z-index:99 !important;">
                        <a href="javascript:void(0)" class="hov-svg-white" data-placement="left"  style="margin-left:9% !important;"
